...
const {addReview, deleteReview, getProductReview, updateReview, getAllReviews} = require('../../controller/user/reviewController');
 ...
 */
router.post('/add/:id', auth, isUser, addReview);
 ...
 */
router.get('/get/:id', auth, isUser, getProductReview);
